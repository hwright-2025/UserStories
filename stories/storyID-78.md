...
# S78: As NICHD ODSS leadership, I want to understand how existing NICHD repositories align with the NIH Data Management and Sharing (DMS) Policy so that we can advise on priorities for repository operations and enhancements  
...
|As an NICHD-funded researcher, I want access to a tool informed by repository assessments so that I can select a repository that aligns with NIH DMS Policy and supports my data type. | TToday, it is difficult to determine if a given system supports DMS Policy requirements.  | My goal is ensure NICHD investments align to the NICHD and NIH data strategies and policies. |

</br>

Related Efforts: 
[E7: NICHD Data Ecosystem Assessment](https://github.com/NIH-NICHD-Ecosystem/E7_NICHD-Data-Ecosystem-Assessment/blob/main/README.md)
